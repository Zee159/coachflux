 ...
 * 
 * Generates structured reports for completed COMMUNICATION coaching sessions.
 */
...
/**
 * Generate Communication Coach report
 */
export function generateCommunicationReport(data: SessionReportData): FormattedReport {
...
/**
 * Communication Report Generator Class
 * Implements FrameworkReportGenerator interface
 */
export class CommunicationReportGenerator {
  generateReport(data: SessionReportData): FormattedReport {
    return generateCommunicationReport(data);
  }
}

// Export singleton instance
export const communicationReportGenerator = new CommunicationReportGenerator();
