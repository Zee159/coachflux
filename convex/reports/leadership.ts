 ...
 * 
 * Generates structured reports for completed Leadership coaching sessions.
 */
...
/**
 * Generate Leadership Coach report
 */
export function generateLeadershipReport(data: SessionReportData): FormattedReport {
...
/**
 * Leadership Report Generator Class
...
export class LeadershipReportGenerator {
  generateReport(data: SessionReportData): FormattedReport {
    return generateLeadershipReport(data);
  }
}

// Export singleton instance
export const leadershipReportGenerator = new LeadershipReportGenerator();
